...
npx @vscode/vsce package --no-update-package-json --baseContentUrl file:// --baseImagesUrl file:// --out tbx-live-server-6.0.3.vsix
...
if [ -f "tbx-live-server-6.0.3.vsix" ]; then
    echo "SUCCESS: VSIX created at tbx-live-server-6.0.3.vsix"
    ls -la tbx-live-server-6.0.3.vsix
